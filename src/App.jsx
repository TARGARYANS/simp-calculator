...
function App() {
  const [interest,setInteest] = useState(0)
  ...
  const handleCalculate=(e)=>{
    ...
    if (!principle || !rate || !year) {
      ...
      setInteest(principle*rate*year/100)
    }
  }
  ...
  return (
    ...
    align-items-center bg-dark'>
      <div style={{width:'600px'}} className='bg-light p-5 rounded'>
        ...
        <div  style={{width:'100%',height:'150px'}} className='d-flex justify-content-center
        align-items-center bg-warning mt-5 text-light shadow rounded flex-column'>
        ...
        <form className="mt-5" onSubmit={handleCalculate}>
          ...
          <TextField className='w-100' id="outlined-basic-principle" label="₹ Principle Amount"
           variant="outlined" name='principle' value={principle || ""}
          ...
          <div className='mb-3'>
          <TextField className='w-100' id="outlined-basic-principle" label="Rate of Interest (%)" 
          variant="outlined" name='rate' value={rate || ""}
          onChange={e=>validateUserInputs(e)}/>
          </div>
          ...
          <div className='mb-3'>
          <TextField className='w-100' id="outlined-basic-principle" label="Time Period (Yr)" 
          ...
          <Button onClick={handleReset} style={{width:'50%',height:'70px'}} className='text-dark' variant="outlined">RESET</Button>
          </Stack>
